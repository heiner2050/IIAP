    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="my-5"> <!-- Espaciado hacia arriba y hacia abajo -->
                <p>Bienvenido a la sección de prestamo, puedes ver todos los equipos que tienes prestados .</p>
            </div>
            <div class="table-container">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        // Consulta SQL para obtener los registros de préstamos para un usuario específico
                        $sql = "SELECT e.serial AS serial, e.nombre AS nombre_equipo, p.fecha_prestamo, p.estado, p.observacion, p.cantidad, p.fecha_devolucion, p.id_prestamo
                        FROM prestamos AS p
                        INNER JOIN usuarios AS u ON p.usuario_id = u.id_usuario
                        INNER JOIN equipos AS e ON p.equipo_id = e.id_equipo
                        ...
                        if ($result && $result->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='8'>No hay préstamos encontrados para este usuario.</td></tr>";
                        }
