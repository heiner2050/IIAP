                    ...
                    <div class="container-fluid">
                        <ul class="nav nav-tabs nav-justified" style="font-size: 17px;">
                            <li style="border-top-left-radius: 10px;">
                                <a href="./prestamation.php" style="text-decoration: none; color: #fff; padding: 10px 20px; display: block; background-color: #007bff; border: 1px solid #007bff;">Todos los préstamos</a>
                            </li>
                            <li class="active" style="border-top-right-radius: 10px;">
                            ...
                            <li style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                                <a href="./reservation.php" style="text-decoration: none; color: #333; padding: 10px 20px; display: block; background-color: #f7f7f7; border: 1px solid #ddd; border-bottom: none;">Reservaciones</a>
                            </li>
                    ...
                    <div class="container-fluid" style="margin: 50px 0;">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-md-3">
                                <img src="../../avatar/calendar_book.png" alt="clock" class="img-responsive center-box mCS_img_loaded" style="max-width: 110px;">
                            </div>
                        ...
                        <div class="table-container">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT r.id_prestamo, e.serial AS serial, ro.nombre AS rol, r.estado, r.observacion, r.cantidad, r.fecha_prestamo, r.fecha_devolucion, u.numero_documento AS documento, u.nombre AS nombre_usuario, e.nombre AS nombre_equipo
            FROM prestamos AS r
            ...
            JOIN roles ro ON ur.id_roles = ro.id_roles";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>
                    <button onclick='confirmarEliminacion(" . $row["id_prestamo"] . ")' class='btn btn-danger'>
                        <i class='fas fa-times-circle'></i>
                                            ...
                                            echo "<td>
                    <td>
                        <button class='btn btn-info btn-file-loan'>
                ...
                echo "  </tr>";
                                        ...
                                        echo "<tr><td colspan='11'>No hay préstamos encontrados.</td></tr>";
                                    }
                                    $conn->close();
                                    ?>
                                </tbody>
