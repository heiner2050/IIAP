                    ...
                    <div class="container-fluid">
                        <ul class="nav nav-tabs nav-justified" style="font-size: 17px;">
                            ...
                            <li class="active" style="border-top-right-radius: 10px;">
                                <a href="./devoluction.php" style="text-decoration: none; color: #fff; padding: 10px 20px; display: block; background-color: #007bff; border: 1px solid #007bff;">Devoluciones pendientes</a>
                            </li>
                    ...
                    <div class="container-fluid" style="margin: 50px 0;">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-md-3">
                                <img src="../../avatar/clock.png" alt="clock" class="img-responsive center-box mCS_img_loaded" style="max-width: 110px;">
                            </div>
                            <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                            Bienvenido a esta sección, aquí se muestran todos los préstamos de equipos que no han sido devueltos por los docentes, estudiantes y personal administrativo
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
